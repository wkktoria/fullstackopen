...
describe("most likes", () => {
  ...
  test("when list has only one blog, equals the author of that with the likes count", () => {
  ...
  test("of a bigger list is the author who has the most likes and the count of these likes", () => {
